...
export const aboutData = {
  ...
  paragraphTwo: 'My goal is to develop technology that can not only solve problems but also deliver unique experiences. Currently, I am exploring the interdisciplinary field of network studies under the UC Davis Social and Political Interacting Networks research group where I contribute code to the Maoz Network Program.',
