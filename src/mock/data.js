...
export const aboutData = {
  ...
  paragraphTwo: 'My goal is to develop technology that can not only solve problems but also deliver unique experiences. Currently, I am exploring the interdisciplenary field of social and political networks under the UC Davis Social and Political Interacting Networks research group wherein I debug existing code and contribute new feautres to the Maoz Network Program.',
